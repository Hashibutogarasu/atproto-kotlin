...
public object RecordViewRecordEmbedsUnionUnknownSerializer :
    UnknownMemberSerializer<RecordViewRecordEmbedsUnion.Unknown>("com.kikinlex.atproto.example.embed.RecordViewRecordEmbedsUnion.Unknown")
    {
  public override fun construct(type: String, raw: JsonObject): RecordViewRecordEmbedsUnion.Unknown
      = RecordViewRecordEmbedsUnion.Unknown(type, raw)
}

public object RecordViewRecordEmbedsUnionSerializer :
    OpenUnionSerializer<RecordViewRecordEmbedsUnion>(RecordViewRecordEmbedsUnion::class) {
  public override fun selectKnownDeserializer(type: String):
      KSerializer<out RecordViewRecordEmbedsUnion>? = when (type) {
  ...
  public override fun selectKnownSerializer(`value`: RecordViewRecordEmbedsUnion):
      KSerializer<out RecordViewRecordEmbedsUnion>? = when (value) {
  ...
  public override fun unknownSerializer(): KSerializer<out RecordViewRecordEmbedsUnion> =
      RecordViewRecordEmbedsUnionUnknownSerializer
}
