...
import com.kikinlex.atproto.generator.naming.EmittedClass
...
import com.kikinlex.atproto.generator.verify.NameEntry
import com.kikinlex.atproto.generator.verify.UnionArms
import com.kikinlex.atproto.generator.verify.UnionMember
import com.kikinlex.atproto.generator.verify.VerificationInput
import com.kikinlex.atproto.generator.verify.VerificationPass
    ...
    public fun generate(documents: List<LexiconDocument>): List<FileSpec> {
        ...
        for (key in symbols.keys) {
            ...
            when (def) {
                ...
                is com.kikinlex.atproto.generator.ir.ArrayDefTopLevel -> Unit // v1: typedef-style array defs skipped
            }
        }
